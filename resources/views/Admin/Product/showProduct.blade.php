                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-12 col-lg-7">
                                            <div class="product-info-section p-3">
                                                ...
                                                <div class="mt-3">
                                                    <h6>Discription :</h6>
                                                    <p class="mb-0">Virgil Abloh’s Off-White is a streetwear-inspired
                                                        collection that continues to break away from the conventions of
                                                        mainstream fashion. Made in Italy, these black and brown Odsy-1000
                                                        low-top sneakers.</p>
                                                </div>
                                                <dl class="row mt-3">
                                                ...
                                                <div class="product-sharing">
                                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                                        {{-- <div class="">
                                                            <a href="{{ route('Product.edit',[$product->id]) }}" class="btn-social bg-twitter"><i
                                                                    class='bx bx-edit'></i></a>
                                                        </div> --}}
                                                        <div class="">
                                                            <a href="{{ route('Product.destroy',['Product'=>$product->id]) }}" class="btn-social bg-youtube"><i
