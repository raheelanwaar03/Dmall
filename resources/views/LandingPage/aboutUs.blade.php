                    ...
                    <div class="row row-cols-2 row-cols-sm-2 row-cols-md-4 row-cols-xl-5 g-4">
                        ...
                        <div class="col">
                            <div class="card border shadow-none">
                                <div class="card-body">
                                    <a href="javscript:;">
                                        <img src="{{ asset('assets/images/brands/08.png') }}" class="img-fluid" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card border shadow-none">
                                <div class="card-body">
                                    <a href="javscript:;">
                                        <img src="{{ asset('assets/images/brands/09.png') }}" class="img-fluid" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card border shadow-none">
                                <div class="card-body">
                                    <a href="javscript:;">
                                        <img src="{{ asset('assets/images/brands/10.png') }}" class="img-fluid" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card border shadow-none">
                                <div class="card-body">
                                    <a href="javscript:;">
                                        <img src="{{ asset('assets/images/brands/11.png') }}" class="img-fluid" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card border shadow-none">
                                <div class="card-body">
                                    <a href="javscript:;">
                                        <img src="{{ asset('assets/images/brands/12.png') }}" class="img-fluid" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card border shadow-none">
                                <div class="card-body">
                                    <a href="javscript:;">
                                        <img src="{{ asset('assets/images/brands/13.png') }}" class="img-fluid" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card border shadow-none">
                                <div class="card-body">
                                    <a href="javscript:;">
                                        <img src="{{ asset('assets/images/brands/14.png') }}" class="img-fluid" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="card border shadow-none">
                                <div class="card-body">
                                    <a href="javscript:;">
                                        <img src="{{ asset('assets/images/brands/15.png') }}" class="img-fluid" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
