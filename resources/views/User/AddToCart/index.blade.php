                            ...
                            <div class="shop-cart-list mb-3 p-3">
                                ...
                                <div class="row align-items-center g-3">
                                    ...
                                    <div class="col-12 col-lg-3">
                                        <form action="{{ route('User.AddToCart.update',['id'=>$cartProduct->id]) }}" method="POST">
                                            @csrf
                                            <div class="cart-action d-flex justify-content-center align-items-center text-center">
                                                <input type="number" name="cart_product_qty" class="form-control rounded-0" value="{{ $cartProduct->cart_product_qty }}" min="1">
                                                {{-- <input type="hidden" value="{{ $cartProduct->product_id }}"> --}}
                                                <button type="submit" class="btn btn-warning text-light">Change</button>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="col-12 col-lg-3">
                                        <div class="text-center">
                                            <div class="d-flex gap-3 justify-content-center justify-content-lg-end">
                                                <a href="{{ route('User.AddToCart.destroy',['id'=>$cartProduct->id]) }}" class="btn btn-outline-dark rounded-0 btn-ecomm"><i class='bx bx-x'></i>Remove</a>
                                ...
                                <div class="d-lg-flex align-items-center gap-2">
                                    <a href="{{ route('welcome') }}" class="btn btn-dark btn-ecomm"><i class='bx bx-shopping-bag'></i> Continue Shoping</a>
                            ...
                            <div class="checkout-form p-3 bg-light">
                                ...
                                <form action="{{ route('User.Address.store') }}" method="POST">
                                    ...
                                    <div class="card rounded-0 border bg-transparent mb-0 shadow-none">
                                        <div class="card-body">
                                            <p class="mb-2">Total Requested Items: <span class="float-end">{{ cartProductQuantity() }}</span>
                                            </p>
                                            <p class="mb-2">Total Price: <span class="float-end">{{ productPrice() }}</span>
                                            </p>
                                            ...
                                            <div class="my-3 border-top"></div>
                                            <h5 class="mb-0">Order Total: <span class="float-end">{{ productPrice() }}</span></h5>
                                            <div class="my-4"></div>
